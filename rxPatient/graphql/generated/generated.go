...
type ComplexityRoot struct {
	...
	Query struct {
		...
		SearchPatientsByLastname func(childComplexity int, lastname string) int
	}
}

type QueryResolver interface {
	SearchPatientsByLastname(ctx context.Context, lastname string) ([]*model.Patient, error)
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.searchPatientsByLastname":
		if e.complexity.Query.SearchPatientsByLastname == nil {
			break
		}

		args, err := ec.field_Query_searchPatientsByLastname_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Query.SearchPatientsByLastname(childComplexity, args["lastname"].(string)), true
...
type Query {
  searchPatientsByLastname(lastname: String!): [Patient!]!
  patients: [Patient!]!
}
`, BuiltIn: false},
}
...
func (ec *executionContext) field_Query_searchPatientsByLastname_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := ec.field_Query_searchPatientsByLastname_argsLastname(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["lastname"] = arg0
...
func (ec *executionContext) field_Query_searchPatientsByLastname_argsLastname(
	ctx context.Context,
	rawArgs map[string]any,
) (string, error) {
...
func (ec *executionContext) _Query_searchPatientsByLastname(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Query_searchPatientsByLastname(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().SearchPatientsByLastname(rctx, fc.Args["lastname"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNPatient2ᚕᚖrxPatientᚋgraphqlᚋmodelᚐPatientᚄ(ctx, field.Selections, res)
}

func (ec *executionContext) fieldContext_Query_searchPatientsByLastname(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_searchPatientsByLastname_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
	...
	for i, field := range fields {
		...
		case "searchPatientsByLastname":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query_searchPatientsByLastname(ctx, field)
				if res == graphql.Null {
...
func (ec *executionContext) marshalNPatient2ᚕᚖrxPatientᚋgraphqlᚋmodelᚐPatientᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Patient) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNPatient2ᚖrxPatientᚋgraphqlᚋmodelᚐPatient(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNPatient2ᚖrxPatientᚋgraphqlᚋmodelᚐPatient(ctx context.Context, sel ast.SelectionSet, v *model.Patient) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
